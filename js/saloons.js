...
export default class SaloonPage {
  ...
  async getSaloons(saloonChoice) /*this.showPlacement.auditorium*/ {  //Loading JSON library with saloon info and returns choosen saloon.

    //TODO use this.showPlacement to get the correct movie saloon
